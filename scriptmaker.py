...
printlog.zs CT script.
Then, use this (arguably very overkill) Python script to define rules for food 
modification and export the actual CT scripts to use with the mod.
